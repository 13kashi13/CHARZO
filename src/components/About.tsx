      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-[340px_1fr] gap-5 mb-5">
          ...
          <div className="rounded-2xl border border-[#00e5a0]/20 overflow-hidden min-h-[280px]">
            <img
              src="/sarthak.jpg"
              alt="Sathak Singh — Founder, CHARZO"
          ...
          <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-7 flex flex-col justify-between">
            <div>
              ...
              <div className="flex items-start gap-4 mb-6">
                <div>
                  <h3 className="text-2xl font-black text-white leading-tight">Sathak Singh</h3>
              ...
              <p className="text-white/45 text-sm leading-relaxed mb-4">
                Sathak began his career at ZOID Technologies, a defence-sector R&D startup, where he was immersed in projects that demanded rigorous engineering and creative problem solving. This environment gave him an obsession with tackling real-world challenges head-on.
              </p>
              <p className="text-white/45 text-sm leading-relaxed">
                At CHARZO, Sathak channels this problem-solving mindset into building practical, accessible EV-charging solutions that move India closer to a cleaner, electrified future.
              </p>
            </div>
